...
#
# 실행:
#   bash raspi_cmd_bridge.sh                    # 기본 포트 /dev/ttyUSB0
#   bash raspi_cmd_bridge.sh --port /dev/ttyACM0
...
#   USE_FASTDDS_UNICAST=1 bash raspi_cmd_bridge.sh
...
echo "중단: Ctrl+C"
echo ""
python3 "$SCRIPT_DIR/raspi_cmd_bridge.py" "$@"
