...
| 상수 | 원본 | 1차 | 2차 | 3차 | 4차 | 5차(현재) | 의도 |
|---|---|---|---|---|---|---|---|
| `MATCH_THRESHOLD` | 0.72 | 0.74 | 0.74 | 0.74 | 0.74 | 0.74 | 진입 엄격 |
| `SEARCH_MATCH_THR` | 0.70 | 0.65 | 0.60 | 0.68 | 0.68 | 0.68 | 재획득 |
| `KEEP_THRESHOLD` | 0.62 | 0.56 | 0.60 | 0.60 | 0.58 | 0.60 | 유지 느슨 폭 조절 |
| `REID_FLOOR` | 0.55 | 0.55 | 0.55 | 0.55 | 0.55 | 0.55 | 진입 ReID 하한 (고정) |
| `KEEP_REID_FLOOR` | 없음 | 0.45 (신규) | 0.52 | 0.52 | 0.52 | 0.52 | 유지 중 ReID 하한 — 타인 차단 핵심 |
| `COLOR_FLOOR` | 0.15 | 0.15 | 0.15 | 0.15 | 0.15 | 0.15 | 색상 하한 (유지 중 미적용) |
| `LOST_MAX` | 20 | 35 | 30 | 30 | 35 | 30 | 유실 유예 프레임 |
| `MIN_CONFIRM_FRAMES` | 3 | 4 | 4 | 4 | 4 | 4 | 진입 확인 프레임 |
| `SEARCH_CONFIRM_FRAMES` | 3 | 3 | 3 | 3 | 3 | 3 | 재획득 확인 프레임 (고정) |
...
- **4차** — 추적 유지 강화: `KEEP_THRESHOLD` 0.60→0.58, `LOST_MAX` 30→35. (`KEEP_REID_FLOOR`는 타인 차단 위해 0.52 유지)
- **5차** — 4차 되돌림(3차 값 복귀): `KEEP_THRESHOLD` 0.58→0.60, `LOST_MAX` 35→30.
