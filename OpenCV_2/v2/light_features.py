...
SEARCH_MATCH_THR   = 0.60   # 완전 유실 탐색 중 재인식 (0.65 시도 후 재획득 불안정해 원본 0.70 복귀)
KEEP_THRESHOLD     = 0.60   # 추적 유지 (원본 0.62→1차 0.56→2차 0.60, 진입과 간격 0.14)
...
LOST_MAX           = 30     # 유실 허용 프레임 (원본 20→1차 35→2차 30)
